							...
							<div class="row profile_user_name">
								...
								<div class="float_left view_top1">
									...
									<div class="col-xl-12 col-md-12 col-sm-12 float_left_width_100">
										...
										<label class="view_user_name_label" style="margin-right: 10px"><?php echo chunk_split(esc_html($user_info->last_name), 32,"<BR>");?></label>										 

										<label class="view_user_name_label"><?php echo chunk_split(esc_html($user_info->first_name),32,"<BR>");?></label>
								...
								<div class="guardian_div">
									...
									<div class="row">
										...
										<div class="col-xl-3 col-md-3 col-sm-12 margin_top_15px">
											...
											<label class="guardian_labels view_page_header_labels"> <?php esc_html_e('Unit Address', 'gym_mgt'); ?> </label><br>
										...
										<div class="col-xl-3 col-md-3 col-sm-12 margin_top_15px">
											...
											<label class="guardian_labels view_page_header_labels"> <?php esc_html_e('Unit Number', 'gym_mgt'); ?> </label><br>
							...
							<div class="col-xl-12 col-md-12 col-sm-12">
								...
								<div class="view_card detail_page_card">
									...
									<div class="qr_main_div">
										...
										<div class="qr_image_div" style="padding:10px;">
